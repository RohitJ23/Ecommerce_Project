...
<nav class="navbar navbar-inverse" role="banner">
 ...
 <section id="feature" >
	...
	<div class="col-sm-4">
	<p style="font-size:20px;">Please Enter Your Paypal Credentials.</p>
	<form name="card" method="post" action="checkoutprint1.php">
	<table cellpadding=10px>
	<tr>
  <th>E-mail Address &nbsp </th> <td> <input type="text" value="" id="cardno" name="cardno" placeholder="E-mail Address"></td>
  </tr>
    <tr>
  <th>Password &nbsp </th> <td> <input type="password" value="" id="cardno" name="cardno" placeholder="Password"></td>
  </tr>
