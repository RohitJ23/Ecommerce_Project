...
<nav class="navbar navbar-inverse" role="banner">
	...
	<section>
	<center><h2 style="font-size:40;">Your Cart</h2>
	...
	<table>
	<th>
	<form name="empty" id="empty" method="post" action="checkout2.php">
	<button type="submit" name="empty1" id="empty1">Empty Cart</input>
	</form>
	</th>
	<th> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </th>
	<th>
	<form name="chkout" id="chkout" method="post" action="gateway.php">
	<button type="submit" name="chkout1" id="chkout1"> Checkout </input>
	</form>
	</th>
	</table>
	</table>
