...
<nav class="navbar navbar-inverse" role="banner">
	...
	<section>
	<center><h2 style="font-size:40;">Thank you for your payment.</h2>
	<h2 style="font-size:25;">Your Order Number: <?php echo "$order";?></h2>
	<p style="font-weight:bold;"> Your order will be delivered within 2-3 business days. <br>
